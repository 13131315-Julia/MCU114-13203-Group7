...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val cities = arrayOf("Taipei", "Keelung", "New Taipei", "Taoyuan", "Hsinchu", "Miaoli", "Taichung", "Changhua", "Nantou", "Chiayi", "Tainan", "Kaohsiung", "Pingtung", "Yilan")

        btnGetTemp.setOnClickListener {
            AlertDialog.Builder(this)
                .setTitle("Select a City")
                .setItems(cities) { _, which ->
                    var selectedCity = cities[which]

                    fetchWeather(cityName=selectedCity)
                }
                .show()
        }
    }
    ...
    private fun fetchWeather(cityName: String) {
        ...
        val apiKey = "3c9cc1f28bc33edd8305f1d2144df894"
